    ...
    def owner_only(func):
        ...
        async def wrapper(self, *args, **kwargs):
            ...
            if not orig_msg or orig_msg.author.id == self.config.owner_id:
                ...
                raise exceptions.PermissionsError("只有擁有者可以使用此指令!", expire_in=30)
    ...
    async def _check_ignore_non_voice(self, msg):
        ...
        if not vc or vc == msg.author.voice.channel:
            ...
            raise exceptions.PermissionsError(
                "你無法在未加入任何語音頻道時使用此指令 (%s)" % vc.name, expire_in=30)
...
#######################################################################################################################
    ...
    async def cmd_restart(self, channel):
        ...
        and restarted.
        """
        await self.safe_send_message(channel, "\N{WAVING HAND SIGN} 重新啟動...")
